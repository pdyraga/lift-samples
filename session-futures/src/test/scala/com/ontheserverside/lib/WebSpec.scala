// Kindly borrowed from Lift framework codebase to avoid problems
// with original WebSpec compiled for another Specs2 version.
...
import net.liftweb.http.{LiftRules, LiftRulesMocker, LiftSession, Req, S}
